...
public class DefineOrientationAll implements IServiceStrategy {
	...
	public static final String RESULT = "C:\\frameworks\\PdfEditor\\pdfrotationed\\rotationedAll.pdf";
	...
	public void SetOrientationAll(String src, String dest) throws IOException, DocumentException {
